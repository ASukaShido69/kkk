...
const categories = [
  ...
  {
    id: "คอมพิวเตอร์ (เทคโนโลยีสารสนเทศ)",
    name: "คอมพิวเตอร์",
    color: "bg-purple-500",
  ...
  {
    id: "สังคม วัฒนธรรม จริยธรรม และอาเซียน",
    name: "สังคม วัฒนธรรม",
    color: "bg-yellow-500",
    darkColor: "bg-yellow-600",
  },
  {
    id: "กฎหมายที่ประชาชนควรรู้",
    name: "กฎหมาย",
    color: "bg-indigo-500",
...
export default function ExamPage() {
  ...
  useEffect(() => {
    ...
    if (savedConfig) {
      ...
      const limitedConfig = {
        ...config,
        numberOfQuestions: Math.min(config.numberOfQuestions, 150),
      };
  ...
  const handleSubmitExam = () => {
    ...
    const examData = {
      ...
      timeSpent,
      examType:
        examConfig?.type === "full" ? "สอบเต็มรูปแบบ" : "สอบแบบกำหนดเอง",
  ...
  const getCategoryProgress = () => {
    const categoryStats: Record<
      string,
      { total: number; answered: number; color: string }
    > = {};
  ...
  return (
    <div
      className={`min-h-screen transition-colors duration-300 ${darkMode ? "dark bg-gray-900" : "bg-primary-bg"}`}
    >
      {/* Main Content Area */}
      <main className="max-w-6xl mx-auto px-4 py-6">
        ...
        {showNavigationGrid && (
          <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 backdrop-blur-sm">
            <div
              className={`rounded-2xl p-6 max-w-5xl w-full mx-4 max-h-[85vh] overflow-auto shadow-2xl border transition-colors ${
                darkMode
            ...
            >
              <div className="flex justify-between items-center mb-6">
                <div className="flex items-center gap-3">
                  <BookOpen
                    className={`w-6 h-6 ${darkMode ? "text-blue-400" : "text-primary-blue"}`}
                  />
                  <h3
              ...
              <div className="mb-6">
                ...
                >
                  <SelectTrigger
                    className={`w-80 ${darkMode ? "bg-gray-700 border-gray-600 text-gray-200" : ""}`}
                  >
                  ...
                  >
                    <SelectItem
                      value="all"
                      className={
                        darkMode ? "text-gray-200 focus:bg-gray-600" : ""
                      }
                    >
                    ...
                    {categories.map((category) => (
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <div
                            className={`w-3 h-3 ${darkMode ? category.darkColor : category.color} rounded-full`}
                          ></div>
                          {category.name}
                        </div>
                      </SelectItem>
              ...
              <div className="grid grid-cols-10 gap-3 mb-6">
                {(selectedCategory === "all"
                  ...
                  const isBookmarked = bookmarkedQuestions.includes(
                    question.id,
                  );
                  ...
                  return (
                    ...
                    >
                      ...
                      {categoryInfo && (
                        <div
                          className={`absolute bottom-0 left-0 right-0 h-1 rounded-b-xl ${darkMode ? categoryInfo.darkColor : categoryInfo.color}`}
                        ></div>
                      )}
                    </Button>
                  );
              ...
              <div
                className={`grid grid-cols-2 md:grid-cols-4 gap-4 text-sm p-4 rounded-xl ${
              ...
              >
                ...
                <div className="flex items-center space-x-2">
                  <div
                    className={`w-5 h-5 rounded-lg shadow-sm border-2 ${
                      darkMode
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center w-full">
                          <span
                            className={`w-10 h-10 text-sm font-bold rounded-full flex items-center justify-center mr-4 transition-all duration-300 ${
                              isSelected
                          ...
                          {isSelected && (
                            <div className="text-primary-blue text-xl ml-2">
                              ✓
                            </div>
                          )}
                        </div>
          ...
          <div className="lg:col-span-1">
            <Card
              className={`sticky top-24 shadow-lg transition-colors ${
                darkMode ? "bg-gray-800 border-gray-700" : "bg-white"
              }`}
            >
              <CardContent className="p-6">
      ...
      {showConfirmSubmit && (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 backdrop-blur-sm">
          <Card
            className={`w-full max-w-lg mx-4 shadow-2xl border transition-colors ${
              darkMode
                ? "bg-gray-800 border-gray-700"
                : "bg-white border-gray-200"
            }`}
          >
            <CardContent className="pt-8 pb-6 text-center">
              <div className="mb-6">
                ...
                <h2
                  className={`text-2xl font-bold mb-3 ${darkMode ? "text-gray-200" : "text-gray-800"}`}
                >
                  ยืนยันการส่งข้อสอบ
                </h2>
                <div
